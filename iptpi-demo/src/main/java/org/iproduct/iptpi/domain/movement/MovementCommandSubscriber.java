...
//	private SchedulerGroup eventLoops = SchedulerGroup.async();
	...
	public MovementCommandSubscriber(PositionFluxion positions, Fluxion<LineReadings> lineReadings) {
...
//		case MOVE_RELATIVE :
//			// start moving - and think later as it comes :)
//			MovementData move = command.getData();
//			int directionL, directionR;
...
//			Position startPos = positions.elementAt(1).get();
//								
//			RelativeMovement relMove = (RelativeMovement) move;
...
//			System.out.println("$$$$$$$$$$$$$$ Target Distance=" + distance);
//
//			double targetHeading, targetDeltaHeading, targetCurvature;
...
//				targetCurvature = hypot(targetDeltaX, targetDeltaY) / (2 * sin(targetDeltaHeading / 2) );
...
//			} else {
//				relMove = (RelativeMovement) move;
//				targetDeltaX = relMove.getDeltaX();
//				targetDeltaY = relMove.getDeltaY();
